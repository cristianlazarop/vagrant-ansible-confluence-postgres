...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "postgres" do |postgres|
    ...
    postgres.vm.network :private_network, ip: "192.168.56.10"
  ...
  # Every Vagrant development environment requires a box. You can search for
  # boxes at https://vagrantcloud.com/search.
  confluence.vm.box = BOX_IMAGE
  confluence.vm.box_version = "0.0.1"
    confluence.vm.network "private_network", ip: "192.168.56.11"
    confluence.vm.synced_folder "data/", "/home/vagrant/vagrant_data"
